...
expName = 'tutorial 3'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\vishweshwari\\OneDrive\\Desktop\\LAB\\tutorial 3_lastrun.py',
